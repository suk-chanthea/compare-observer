...
class GitSourceCompareDialog(QDialog):
    ...
    def scan_changes(self):
        ...
        self.status_label.setText(f"Found {len(self.changes)} differences")
...
class FileWatcherTable(QTableWidget):
    ...
    def add_file(self, file_path):
        ...
        # btn_remove.setFixedSize(20, 30)  # Set width 20, height 30
        # btn_remove.setStyleSheet("background: transparent; border: none;")  # Make background transparent
